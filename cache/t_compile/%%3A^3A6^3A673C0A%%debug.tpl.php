<?php /* Smarty version 2.6.25-dev, created on 2018-01-16 22:58:50
         compiled from file:/var/www/html/iisue_dev/lib/pkp/lib/vendor/smarty/smarty/libs/debug.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'assign_debug_info', 'file:/var/www/html/iisue_dev/lib/pkp/lib/vendor/smarty/smarty/libs/debug.tpl', 3, false),array('function', 'cycle', 'file:/var/www/html/iisue_dev/lib/pkp/lib/vendor/smarty/smarty/libs/debug.tpl', 119, false),array('modifier', 'escape', 'file:/var/www/html/iisue_dev/lib/pkp/lib/vendor/smarty/smarty/libs/debug.tpl', 102, false),array('modifier', 'string_format', 'file:/var/www/html/iisue_dev/lib/pkp/lib/vendor/smarty/smarty/libs/debug.tpl', 105, false),array('modifier', 'debug_print_var', 'file:/var/www/html/iisue_dev/lib/pkp/lib/vendor/smarty/smarty/libs/debug.tpl', 121, false),)), $this); ?>
...
?>&nbsp;&nbsp;&nbsp;<?php endfor; endif; ?>
    <font color=<?php if ($this->_tpl_vars['_debug_tpls'][$this->_sections['templates']['index']]['type'] == 'template'): ?>brown<?php elseif ($this->_tpl_vars['_debug_tpls'][$this->_sections['templates']['index']]['type'] == 'insert'): ?>black<?php else: ?>green<?php endif; ?>>
        <?php echo ((is_array($_tmp=$this->_tpl_vars['_debug_tpls'][$this->_sections['templates']['index']]['filename'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp, 'html')); ?>
</font>
...
">
            <th>{$<?php echo ((is_array($_tmp=$this->_tpl_vars['_debug_keys'][$this->_sections['vars']['index']])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp, 'html')); ?>
}</th>
...
?>
        <tr class="<?php echo smarty_function_cycle(array('values' => "odd,even"), $this);?>
">
            <th>{#<?php echo ((is_array($_tmp=$this->_tpl_vars['_debug_config_keys'][$this->_sections['config_vars']['index']])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp, 'html')); ?>
#}</th>
...
// <![CDATA[
    ...
    _smarty_console.document.write('<?php echo ((is_array($_tmp=$this->_tpl_vars['debug_output'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp, 'javascript')); ?>
');
