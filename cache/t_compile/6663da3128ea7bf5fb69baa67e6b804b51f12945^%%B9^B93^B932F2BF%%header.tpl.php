...
" width="180" height="90" />
		...
		<!-- Definiendo el banner y enseguida el menú principal -->
			...
			<img src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/plugins/themes/default-child/images/banner-perfiles-educativos.jpg" width="100%" />
		</div>
